...
def pika_plugins(_pikamod=None):
    ...
    modules["userbot"] = pikabot; modules["userbot.utils"] = _utilz; modules["uniborg.util"] = _utilz;modules["INFINIX"] = pikabot; modules["infinix"] = pikabot ; spec.loader.exec_module(_pika); bot.pika_cmd[_pikamod] = _pika; modules["pikabot"+_pikamod] = _pika; logpl.info("🔥Imported "+_pikamod)
